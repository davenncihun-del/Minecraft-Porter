    ...
    private String processToml(String content) {
        ...
        for (String line : lines) {
            ...
            if (sectionMatcher.find()) {
                ...
                currentModLoader = ""; // reset section states
                currentModId = "";
            }
            ...
            // Processing version ranges cleanly inside dependency declarations
            if (currentSection.startsWith("dependencies.") && cleanLine.startsWith("versionRange")) {
                if (currentSection.endsWith("minecraft")) {
                    line = line.replaceAll("versionRange\\s*=\\s*[\"']([^\"']*)[\"']", "versionRange = \"[" + targetVersion + ",)\"");
                } else if (currentSection.endsWith("neoforge") || currentSection.endsWith("forge")) {
                    line = line.replaceAll("versionRange\\s*=\\s*[\"']([^\"']*)[\"']", "versionRange = \"" + resolvedLoaderVersion + "\"");
                } else if (currentSection.endsWith("javafml")) {
                    line = line.replaceAll("versionRange\\s*=\\s*[\"']([^\"']*)[\"']", "versionRange = \"[0,)\""); // Preserve static FML spectrum
                }
            }
